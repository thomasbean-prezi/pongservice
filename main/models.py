...
class Match(models.Model):
    ...
    player1 = models.ForeignKey(Player, on_delete=models.CASCADE, related_name="player1") #I think this may be wrong...
    player2 = models.ForeignKey(Player, on_delete=models.CASCADE, related_name="player2") #Many players to many matches
